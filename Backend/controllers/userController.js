...
const updateUserProfile = asyncHandler(async (req, res) => {
  ...
  if (user) {
    ...
    user.profile.mobile = req.body.profile.mobile || user.profile.mobile;
    user.profile.website = req.body.profile.website || user.profile.website;
    user.profile.location = req.body.profile.location || user.profile.location;
    user.profile.status = req.body.profile.status || user.profile.status;
